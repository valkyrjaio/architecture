...
(`CacheConfig`, `CacheRedisConfig`), and all of these live in the component's
`Data\` segment. The component's service provider publishes each contract as
its own container binding.
