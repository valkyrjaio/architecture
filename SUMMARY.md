...
**Cache command note:** No framework holds a cache generation command in any language. `sindri` generates each cache
file.
...
- Go: `sindri` (module: `github.com/valkyrjaio/sindri-go/vN`) — go/analysis, go/ast (stdlib)
